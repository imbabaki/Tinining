<x-app-layout>
    ...
    <div class="movies-container2">
        <div class="movie-item2">
            ...
            <div class="booking-container">
                <form id="bookingForm" action="{{ route('reserve.seat') }}" method="POST">
                    @csrf
                    ...
                    <div class="table-container">
                        <table>
                            ...
                            <tr>
                                <td>No. of Seats</td>
                                <td>
                                    <input type="number" id="quantity" name="quantity" min="1" style="width: 80%; height: 30px;">
                                </td>
                            </tr>
                            <tr>
                                <td>Amount</td>
    ...
    <script>
        ...
        document.getElementById('quantity').addEventListener('change', calculateAmount);
    </script>
</x-app-layout>
